...
const AboutUs = () => {
  ...
  const tabContent: any = {
    who: {
      title: "Who We Are",
      content: "We are a purpose-driven community dedicated to raising wholesome, confident, and intentional women. At our core is a passion for empowering girls to grow, thrive, and lead — not just in their own lives, but in the world around them.",
    ...
    what: {
      title: "What We Do",
      content: "We create safe, nurturing spaces for girls to explore their identity and develop the tools they need to succeed. Through mentorship, coaching, counselling, and advocacy, we walk alongside each girl on her journey to self-discovery, confidence, and purposeful living.",
      highlight: "Safe, nurturing spaces",
      services: ["Mentorship", "Coaching", "Counselling", "Advocacy"],
      description: "Whether in schools, communities, or one-on-one sessions, our programs are designed to inspire lasting transformation — emotionally, mentally, and socially."
    },
    vision: {
      title: "Our Vision",
      content: "A world where every girl is seen, heard, and empowered to become the woman she was created to be — confident, whole, and intentional in every part of her life.",
      highlight: "Every girl empowered",
      qualities: ["Confident", "Whole", "Intentional"]
    },
    impact: {
      title: "Our Impact",
      content: "We're already seeing change. From mentorship circles to community outreaches and mental wellness programs, our work is reaching hearts, shifting mindsets, and building futures. One girl at a time, we're creating ripples of transformation that go far beyond today.",
      highlight: "Creating ripples of transformation",
      programs: ["Mentorship Circles", "Community Outreach", "Mental Wellness Programs"]
    }
  };

  return (
    <section ref={sectionRef} className="py-20 bg-gradient-to-br from-gray-50 via-white to-pink-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Empowering <span className="text-[#c8335a]">Tomorrow's</span> Leaders
          </motion.h2>
          ...
          >
            Building a community where every girl discovers her potential, embraces her worth, and steps boldly into her purpose.
          </motion.p>
        </motion.div>
        ...
        >
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              {(tabContent[activeTab].services || tabContent[activeTab].programs || tabContent[activeTab].qualities) && (
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                ...
                >
                  {(tabContent[activeTab].services || tabContent[activeTab].programs || tabContent[activeTab].qualities)?.map((item: string | number | bigint | boolean | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | Promise<string | number | bigint | boolean | React.ReactPortal | React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined> | null | undefined, index: React.Key | null | undefined) => (
                    <span
                      key={index}
                  ...
                  >
                    ...
                    {tabContent[activeTab].stats && (
                      <div className="grid grid-cols-3 gap-4 mt-6">
                        {tabContent[activeTab].stats.map((stat:{number:number, label:string}, index:number) => (
                          <motion.div
                            key={index}
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="bg-gradient-to-r from-[#c8335a]/10 to-[#a02847]/10 rounded-3xl p-8 lg:p-12">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Join us in empowering the next generation of confident, purposeful women. Together, we can create lasting change.
            </p>
